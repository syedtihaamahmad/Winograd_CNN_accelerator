...
//};
	...
	StreamingDataWidthConverter_Batch<TO::width, TO_32::width, (OFM_DIM_C3*OFM_DIM_C3*OFM_CH_C3)/(out_parallel_C3)>(c3_outstream, outstream, reps);
	Stream2Mem<TO_32::width,(OFM_DIM_C3*OFM_DIM_C3*OFM_CH_C3)/(out_parallel_C3*2) >(outstream, out);
