...
ofstream out_sdk_file("../dbg/out_L4_sdk.txt");
...
int main()
{
	...
	out_features OUT = {OFM_DIM_C4, OFM_CH_C4, NUM_REPS};
...
//			#include "7_padded.txt"
			#include "../data/cifar10_cnv/input_image.txt"
			};
...
#include "../data/cifar10_cnv/pool4(gold)"
};
//	cout.clear();
