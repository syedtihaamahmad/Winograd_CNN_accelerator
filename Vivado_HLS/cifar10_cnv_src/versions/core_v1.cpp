...
#include "../data/cifar10_cnv/conv3_packed_out2.txt"
};

static ap_uint<simd_C4*bitw> weights_C4[OFM_CH_C4/out_parallel_C4][OFM_CH_C3/simd_C4][pe_num_C4] = {
#include "../data/cifar10_cnv/conv4_packed_out2.txt"
};
#endif
...
hls::stream<TO_32> outstream("outstream");
	...
	load<ap_uint<simd_C3*bitw>>("/home/ab/projects/hls_projects/cifar10_cnv/data/cifar10_cnv/conv3_packed_out2.txt", l, weights_C3);
	...
	load<ap_uint<simd_C4*bitw>>("/home/ab/projects/hls_projects/cifar10_cnv/data/cifar10_cnv/conv4_packed_out2.txt", l, weights_C4);
#endif
	...
	Stream2Mem<TO_32::width,(OFM_DIM_C4*OFM_DIM_C4*OFM_CH_C4)/(out_parallel_C4*2) >(outstream, out);
