...
//Conv1
#define simd_C1 2
#define out_parallel_C1 2 //This is adjustable ***Must be 1,2,4,8 i.e. divisible by filter number
...
//Conv2
#define simd_C2 2
#define out_parallel_C2 2 //This is adjustable ***Must be 1,2,4,8 i.e. divisible by filter number
...
//Conv3
#define simd_C3 2
#define out_parallel_C3 2 //This is adjustable ***Must be 1,2,4,8 i.e. divisible by filter number
...
//Conv4
#define simd_C4 2
#define out_parallel_C4 2 //This is adjustable ***Must be 1,2,4,8 i.e. divisible by filter number
...
typedef ap_uint<out_size_C3> TO;
