...
#else
static ap_uint<simd_C0*bitw> weights_C0[OFM_CH_C0/out_parallel_C0][IMG_CH/simd_C0][pe_num_C0] = {
#include "../data/cifar10_cnv/conv0_packed_out2.txt"
};
...
hls::stream<TO_32> outstream("outstream");
	...
	load<ap_uint<simd_C0*bitw>>("/home/ab/projects/hls_projects/cifar10_cnv/data/cifar10_cnv/conv0_packed_out2.txt", l, weights_C0);
