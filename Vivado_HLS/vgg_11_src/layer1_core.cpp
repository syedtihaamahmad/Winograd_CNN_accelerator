...
//};
	...
	StreamingDataWidthConverter_Batch<TO::width, TO_32::width, (OFM_DIM_C0*OFM_DIM_C0*OFM_CH_C0)/out_parallel_C0>(c0_outstream, outstream, reps);
	Stream2Mem<TO_32::width,(OFM_DIM_C0*OFM_DIM_C0*OFM_CH_C0)/(out_parallel_C0*4) >(outstream, out, reps);
